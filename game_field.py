...
font = pygame.font.Font('fonts/orbitron-light.ttf', 20)

game = Menu(punkts)
game.menu()


store_bar = pygame.Surface((WIDTH, 100))

#Настройка звука
#pygame.mixer.init()
#mainSound = pygame.mixer.Sound('sounds/PACMAN_DUBSTEP.ogg')
#mainSound.play(-1)
...
while True:
    ...
    sprites.draw(screen)
    window.blit(screen, (0, 0))
    window.blit(store_bar, (0, HEIGHT))
    if pacman.lifes == 3:
